...
public class ControllerCreateUser {
	...
	// user input fields
	@FXML
	private TextField create_normalEnterUsername;

	@FXML
	private TextField create_normalEnterFirstname;

	@FXML
	private TextField create_normalEnterLastname;

	@FXML
	private TextField create_normalEnterMobile;

	@FXML
	private Button create_normalCreateImage;

	@FXML
	private TextField create_normalEnterAddLn1;

	@FXML
	private TextField create_normalEnterAddLn2;

	@FXML
	private TextField create_normalEnterAddCity;

	@FXML
	private TextField create_normalEnterAddPostcode;
	...
	@FXML
	private ImageView normalUserImage;
	...
	/**
	 * Method to set the profile picture as the draw image and select it as your
	 * image
	 * 
	 * @param e
	 */
	...
	private void handleCreateButtonEvent(ActionEvent e) {
		...
		try { // get data from fields
			l.newNormalUser(create_normalEnterUsername.getText(), password.getText(),
					create_normalEnterFirstname.getText(), create_normalEnterLastname.getText(),
					Integer.parseInt(create_normalEnterMobile.getText()), address, Storage.returnImagenum());
