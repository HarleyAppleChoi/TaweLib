...
public class EditDvdGuiController {
	...
	public void editDVDEvent(ActionEvent e) throws NumberFormatException, SQLException {
		...
		l.editDVD(Integer.parseInt(enterID.getText()), enterTitle.getText(), enterYear.getText(), "",
				Integer.parseInt(enterNumCopies.getText()), Integer.parseInt(editDuration.getText()),
				enterDirector.getText(), enterLanguage.getText(), enterRunTime.getText(), subtitle);
	}
